...
/**
 * Controlador pacientesController/
 *
 * @author MCHANG mchang@hmetro.med.ec
 *
 */

class pacientesController extends Controllers implements IControllers
{
        ...
        if (!is_null($router->getMethod()) && is_null($router->getId())) {
            switch ($router->getMethod()) {
                ...
                case '':
                    ...
                    $this->name_template = 'pacientes/v2/roles/' . $this->user['rol'] . '/pacientes';
