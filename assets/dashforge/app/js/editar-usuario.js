...
if (document.getElementById('f-editar-usuario')) {
    document.getElementById('f-editar-usuario').onkeypress = function(e) {
        if (!e) e = window.event;
