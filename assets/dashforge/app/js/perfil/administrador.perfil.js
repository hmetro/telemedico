 ...
 function route() {
     router.on({
         ...
         '/:id_user/eliminar': function(params) {
             getEliminarUsuario(params.id_user);
         },
 ...
 function getEliminarUsuario(id) {
     fetch('api/usuario', {
         method: "GET",
         headers: {
         ...
         if (perfil_id === data.customData.id) {
             router.navigate('/' + id + '/datos-personales');
         }
         console.log('data = ', data);
         $('#content').html(template($('#v-eliminar-usuario').html(), {}));
         loadLinks(data);
 ...
 function getEditPass(id) {
     fetch('api/usuario', {
         ...
         $('.eliminar').click(function(e) {
             e.stopImmediatePropagation();
             e.preventDefault();
             router.navigate('/' + $(this).attr('id') + '/eliminar');
         });
     }).catch(function(err) {
         console.error(err);
     });
